...
void gen_dBG_index(struct bit256KmerPara bit_para, struct para_dBGindex &sdBGidx, char * p_dbg_path, uint32_t thread_num, char **reftmp)	//用CDBGO生成的文件生成一个整体的dBG index
{
